...
'database.connections.sqlsrv.password','database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.mysql_control_leader.driver',
'database.connections.mysql_control_leader.url','database.connections.mysql_control_leader.host','database.connections.mysql_control_leader.port','database.connections.mysql_control_leader.database','database.connections.mysql_control_leader.username',
'database.connections.mysql_control_leader.password','database.connections.mysql_control_leader.unix_socket','database.connections.mysql_control_leader.charset','database.connections.mysql_control_leader.collation','database.connections.mysql_control_leader.prefix',
'database.connections.mysql_control_leader.prefix_indexes','database.connections.mysql_control_leader.strict','database.connections.mysql_control_leader.engine','database.connections.mysql_control_leader.options','database.migrations.table',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\USER\\Herd\\pt-car\\public\\storage',
...
'kalibrasi.','kalibrasi.admin.master-lists.search','control.schedule-plans.index','control.schedule-plans.create','control.schedule-plans.store',
'control.schedule-plans.show','control.schedule-plans.edit','control.schedule-plans.update','control.schedule-plans.destroy','control.schedule-plans.details.index',
'control.schedule-plans.details.create','control.schedule-plans.details.store','control.details.show','control.details.edit','control.details.update',
'control.details.destroy','control.checksheets.create','control.drafts.start','control.heartbeat','control.checksheets.partB',
'control.checksheets.store','control.api.schedules.options','storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.toast','control.checksheets.part-a','control.checksheets.part-b','control.checksheets.pick-date',
'dashboards.control_leader','dashboards.kalibrasi','kalibrasi.admin.equipments.index','kalibrasi.admin.equipments.partials.pagination','kalibrasi.admin.equipments.partials.table_rows',
...
'kalibrasi.report.repair','layouts.app','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
