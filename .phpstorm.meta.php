...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.web_control_leader.driver' => 'string',
            'auth.guards.web_control_leader.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.users_control_leader.driver' => 'string',
            'auth.providers.users_control_leader.model' => 'string',
            ...
            'database.connections.mysql_control_leader.driver' => 'string',
            'database.connections.mysql_control_leader.url' => 'NULL',
            'database.connections.mysql_control_leader.host' => 'string',
            'database.connections.mysql_control_leader.port' => 'string',
            'database.connections.mysql_control_leader.database' => 'string',
            'database.connections.mysql_control_leader.username' => 'string',
            'database.connections.mysql_control_leader.password' => 'string',
            'database.connections.mysql_control_leader.unix_socket' => 'string',
            'database.connections.mysql_control_leader.charset' => 'string',
            'database.connections.mysql_control_leader.collation' => 'string',
            'database.connections.mysql_control_leader.prefix' => 'string',
            'database.connections.mysql_control_leader.prefix_indexes' => 'boolean',
            'database.connections.mysql_control_leader.strict' => 'boolean',
            'database.connections.mysql_control_leader.engine' => 'NULL',
            'database.connections.mysql_control_leader.options' => 'array',
            ...
            'filesystems.links.C:\Users\Admin\Documents\Projects\pt-car\public\storage' => 'string',
...
'auth.guards.web.provider','auth.guards.web_control_leader.driver','auth.guards.web_control_leader.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.users_control_leader.driver','auth.providers.users_control_leader.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
...
'database.connections.sqlsrv.prefix_indexes','database.connections.mysql_control_leader.driver','database.connections.mysql_control_leader.url','database.connections.mysql_control_leader.host','database.connections.mysql_control_leader.port',
'database.connections.mysql_control_leader.database','database.connections.mysql_control_leader.username','database.connections.mysql_control_leader.password','database.connections.mysql_control_leader.unix_socket','database.connections.mysql_control_leader.charset',
'database.connections.mysql_control_leader.collation','database.connections.mysql_control_leader.prefix','database.connections.mysql_control_leader.prefix_indexes','database.connections.mysql_control_leader.strict','database.connections.mysql_control_leader.engine',
'database.connections.mysql_control_leader.options','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\Admin\\Documents\\Projects\\pt-car\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'ping','welcome','login',
'logout','dashboard','kalibrasi.print.label','kalibrasi.api.count.equipments','kalibrasi.api.get.masterlist',
'kalibrasi.api.get.actual.value','kalibrasi.api.get.repair.data','kalibrasi.print.report.masterlist','kalibrasi.print.report.repair','kalibrasi.update.masterlist.print',
'kalibrasi.report.menu','kalibrasi.report.search','kalibrasi.report.masterlist','kalibrasi.report.repairs','kalibrasi.input.new.equipment',
'kalibrasi.store.equipment','kalibrasi.input.calibration.data','kalibrasi.store.calibration','kalibrasi.edit.calibration','kalibrasi.input.repair',
'kalibrasi.store.repair','kalibrasi.edit.repair','kalibrasi.standards.store','kalibrasi.admin.users.index','kalibrasi.admin.users.store',
'kalibrasi.admin.users.update','kalibrasi.','kalibrasi.admin.users.search','kalibrasi.admin.standards.index','kalibrasi.admin.standards.update',
'kalibrasi.admin.standards.store','kalibrasi.','kalibrasi.admin.standards.search','kalibrasi.admin.units.index','kalibrasi.admin.units.store',
'kalibrasi.admin.units.update','kalibrasi.','kalibrasi.admin.units.search','kalibrasi.admin.equipments.index','kalibrasi.admin.equipments.store',
'kalibrasi.admin.equipments.update','kalibrasi.','kalibrasi.admin.equipments.search','kalibrasi.admin.master-lists.index','kalibrasi.admin.master-lists.store',
'kalibrasi.admin.master-lists.update','kalibrasi.','kalibrasi.admin.master-lists.search','kalibrasi.admin.master-lists.export','control.schedule.index',
'control.schedule.store','control.schedule.edit','control.schedule.update','control.schedule.updateCellLeader','control.schedule.updateDivision',
'control.schedule.addUser','control.schedule.removeUser','control.operator.index','control.operator.store','control.operator.update',
'control.operator.','control.operator.search','control.admin.question.index','control.admin.question.create','control.admin.question.store',
'control.admin.question.edit','control.admin.question.update','control.admin.question.destroy','control.admin.question.updateOrder','control.admin.users.index',
'control.admin.users.store','control.admin.users.update','control.admin.users.','control.admin.users.search','control.admin.users.getSuperiors',
'control.checksheets.create','control.drafts.start','control.heartbeat','control.checksheets.partB','control.checksheets.store',
'storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.toast','control.admin.questions._table','control.admin.questions.create','control.admin.questions.edit',
'control.admin.questions.index','control.admin.users.index','control.admin.users.partials.table_rows','control.checksheets.part-a','control.checksheets.part-b',
'control.checksheets.pick-date','control.schedule.operator','control.schedule.partials.table_rows','control.schedule.schedule_leader','control.schedule.schedule_supervisor',
'dashboards.control_leader','dashboards.kalibrasi','exports.master','kalibrasi.admin.equipments.index','kalibrasi.admin.equipments.partials.pagination',
'kalibrasi.admin.equipments.partials.table_rows','kalibrasi.admin.master-lists.index','kalibrasi.admin.master-lists.partials.pagination','kalibrasi.admin.master-lists.partials.table_rows','kalibrasi.admin.standards.index',
'kalibrasi.admin.standards.partials.pagination','kalibrasi.admin.standards.partials.table_rows','kalibrasi.admin.units.index','kalibrasi.admin.units.partials.pagination','kalibrasi.admin.units.partials.table_rows',
'kalibrasi.admin.users.index','kalibrasi.admin.users.partials.pagination','kalibrasi.admin.users.partials.table_rows','kalibrasi.input.calibration-data','kalibrasi.input.new-equipment',
'kalibrasi.input.repair-data','kalibrasi.print-label','kalibrasi.print-report-masterlist','kalibrasi.print-report-repair','kalibrasi.report.masterlist',
'kalibrasi.report.menu','kalibrasi.report.repair','layouts.app','pdf.master','welcome',
...
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.Admin.Documents.Projects.pt-car.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_PASSWORD','DB_DATABASE_CONTROL_LEADER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
