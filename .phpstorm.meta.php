...
'control.schedule.store','control.schedule.edit','control.schedule.update','control.schedule.updateCell','control.schedule.addUser',
'control.schedule.removeUser','control.admin.question.index','control.admin.question.create','control.admin.question.store','control.admin.question.edit',
'control.admin.question.update','control.admin.question.destroy','control.admin.question.updateOrder','control.admin.users.index','control.admin.users.store',
'control.admin.users.update','control.admin.users.','control.admin.users.search','control.checksheets.create','control.drafts.start',
'control.heartbeat','control.checksheets.partB','control.checksheets.store','control.api.schedules.options','storage.local',);
...
'control.admin.questions.index','control.admin.users.index','control.admin.users.partials.pagination','control.admin.users.partials.table_rows','control.checksheets.part-a',
'control.checksheets.part-b','control.checksheets.pick-date','control.schedule.edit','control.schedule.index','dashboards.control_leader',
'dashboards.kalibrasi','exports.master','kalibrasi.admin.equipments.index','kalibrasi.admin.equipments.partials.pagination','kalibrasi.admin.equipments.partials.table_rows',
'kalibrasi.admin.master-lists.index','kalibrasi.admin.master-lists.partials.pagination','kalibrasi.admin.master-lists.partials.table_rows','kalibrasi.admin.standards.index','kalibrasi.admin.standards.partials.pagination',
'kalibrasi.admin.standards.partials.table_rows','kalibrasi.admin.units.index','kalibrasi.admin.units.partials.pagination','kalibrasi.admin.units.partials.table_rows','kalibrasi.admin.users.index',
'kalibrasi.admin.users.partials.pagination','kalibrasi.admin.users.partials.table_rows','kalibrasi.input.calibration-data','kalibrasi.input.new-equipment','kalibrasi.input.repair-data',
'kalibrasi.print-label','kalibrasi.print-report-masterlist','kalibrasi.print-report-repair','kalibrasi.report.masterlist','kalibrasi.report.menu',
'kalibrasi.report.repair','layouts.app','pdf.master','welcome','laravel-exceptions-renderer::components.badge',
