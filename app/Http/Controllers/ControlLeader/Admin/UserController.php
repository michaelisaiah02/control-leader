...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('control.admin.users.index')->with('success', 'User added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('control.admin.users.index')
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('control.admin.users.index')->with('success', 'User has been successfully deleted.');
    }
