...
@section('content')
    <form method="POST" action="{{ route('listProblem.update', ['type' => $type, 'id' => 1]) }}" class="px-5">
        @csrf
        @method('PUT')
        <div class="d-flex flex-column gap-1">
            ...
            <div class="d-flex justify-content-between w-100">
                <div class="d-flex align-items-center gap-2 w-100">
                    <label for="countermeasure"
                        class="col-md-2 text-center form-label bg-primary text-white px-4 py-2 rounded shadow border border-white">Countermeasure</label>
            ...
            <div class="d-flex justify-content-between w-100">
                <div class="d-flex align-items-center gap-2 w-100">
                    <label for="department"
                        class="col-md-2 text-center form-label bg-primary text-white px-4 py-2 rounded shadow border border-white">Status</label>
            ...
            <div class="d-flex justify-content-between w-100">
                <div class="d-flex align-items-center gap-2 w-100">
                    <label for="due_date"
                        class="col-md-2 text-center form-label bg-primary text-white px-4 py-2 rounded shadow border border-white">Due
                        Date</label>
