    ...
    <form method="POST" class="needs-validation" enctype="multipart/form-data" id="calibration-form"
        ...
        <div class="col-md-6 ps-0 pe-1">
          <div class="input-group input-group-sm mb-1">
            ...
            <input type="text" aria-label="No ID" placeholder="-"
              ...
              value="{{ old('id_num') ?? $pending?->masterList->id_num }}" {{ old('id_num') ? '' : 'autofocus' }}
              name="id_num" id="id-num" autocomplete="off" maxlength="7" required
              value="{{ old('id_num') ?? $pending?->masterList->id_num }}" {{ old('id_num') ? '' : 'autofocus' }}>
            <input type="text" aria-label="No SN" placeholder="No SN" class="form-control text-center width-label-1"
              id="sn-num" disabled>
          </div>
          <div class="input-group input-group-sm mb-1">
            <label class="input-group-text bg-primary text-light width-label-1" for="calibration-date">Calibration
              Date</label>
            <input type="date" aria-label="Date Now" placeholder="Date Now"
              class="form-control width-label-1 @error('calibration_date') is-invalid @enderror" id="calibration-date"
              name="calibration_date" value="{{ old('calibration_date') ?? now()->toDateString() }}"
          ...
          <div class="input-group input-group-sm mb-1">
            ...
            <input type="text" class="form-control" placeholder="auto" id="capacity" aria-describedby="capacity"
              disabled>
          ...
          <div class="input-group input-group-sm mb-1">
            ...
            <input type="text" class="form-control calibration-type" placeholder="Internal / External" disabled>
          </div>
        </div>
            ...
            <div class="col">
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-1" name="param_01" placeholder="act" step="0.00001" value="{{ old('param_01') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-2" name="param_02" placeholder="act" step="0.00001" value="{{ old('param_02') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-3" name="param_03" placeholder="act" step="0.00001" value="{{ old('param_03') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-4" name="param_04" placeholder="act" step="0.00001" value="{{ old('param_04') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-5" name="param_05" placeholder="act" step="0.00001" value="{{ old('param_05') }}">
              </div>
            </div>
            <div class="col">
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-6" name="param_06" placeholder="act" step="0.00001" value="{{ old('param_06') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-7" name="param_07" placeholder="act" step="0.00001" value="{{ old('param_07') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-8" name="param_08" placeholder="act" step="0.00001" value="{{ old('param_08') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-9" name="param_09" placeholder="act" step="0.00001" value="{{ old('param_09') }}">
              </div>
              <div class="input-group input-group-sm mb-1">
                ...
                <input type="number"
                  ...
                  id="act-10" name="param_10" placeholder="act" step="0.00001" value="{{ old('param_10') }}">
              </div>
            </div>
        ...
        <table class="table table-sm table-bordered align-middle text-nowrap">
          ...
          <tbody class="table-group-divider">
            @foreach ($results as $result)
              <tr>
                <td><button type="button" class="btn btn-primary btn-select-id {{ $pending ? 'disabled' : '' }}"
                    data-num="{{ $result->id }}" data-id="{{ $result->id_num }}">{{ $loop->iteration }}</button>
                </td>
                ...
                <td>
                  @if ($result->certificate)
                    <button type="button" class="btn btn-primary btn-view-certificate" data-bs-toggle="modal"
                      data-bs-target="#certificateModal" data-path="{{ asset('storage/' . $result->certificate) }}"
      ...
      <div class="row justify-content-end">
        <div class="col-6 col-md-auto text-center mb-1 mb-md-0">
          <a href="{{ route('dashboard', ['key' => 'menu-input', 'application' => 'KALIBRASI']) }}"
        ...
        <div class="col-6 col-md-auto text-center mb-1 mb-md-0">
          <button type="button" class="btn btn-primary {{ $pending ? 'disabled' : '' }}" data-bs-toggle="modal"
              ...
              @foreach ($results as $result)
                <tr>
                  <td><button class="btn btn-primary btn-select-id" data-num="{{ $result->id }}"
                      data-id="{{ $result->id_num }}" data-bs-dismiss="modal">{{ $loop->iteration }}</button></td>
                  <td>{{ $result->calibration_date->format('d-m-Y') }}</td>
                  <td>{{ $result->id_num }} / {{ $result->masterList->sn_num }}</td>
...
@section('scripts')
  <script type="module">
    ...
    function fetchMasterList(idNum) {
      ...
      if ($('#id-result').val() !== '') {
        $('#calibration-form').attr('action',
          `{{ url('/kalibrasi/input/calibration-data') }}/${$('#id-result').val()}`);
      }
      currentAjax = $.ajax({
        url: `{{ url('/kalibrasi/get-masterlist') }}/${idNum}`,
        method: 'GET',
        headers: {
    ...
    function fetchActualValue(id) {
      $.ajax({
        url: `{{ url('/kalibrasi/get-actual-value') }}/${id}`,
        method: 'GET',
        success: function(data) {
    ...
    $(document).on('click', '.btn-select-id', function() {
      ...
      $('#calibration-form').attr('action',
        `{{ url('/kalibrasi/input/calibration-data') }}/${num}`);
    });
    ...
    $('#id-num').on('focus', function() {
      $('#id-result').val('');
      $('#calibration-form').attr('action', "{{ route('kalibrasi.store.calibration') }}");
    });
