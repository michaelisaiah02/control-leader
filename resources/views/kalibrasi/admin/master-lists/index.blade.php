  ...
  <div class="container mt-3">
    <div class="row justify-content-md-between justify-content-center align-items-center mb-3">
      ...
      <div class="col-auto ms-md-auto my-2 my-md-0 d-flex align-items-center">
        ...
        <input type="search" class="form-control" placeholder="Search..." id="search-master-list" autocomplete="off">
      </div>
    </div>
    ...
    <div class="text-center row justify-content-between align-items-start">
      ...
      <div class="col-auto">lass="col-auto">
    ...
    <div class="modal-dialog">
      <form class="modal-content needs-validation" method="POST" id="masterlistForm" novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            <div class="form-floating">
              <input type="date" class="form-control" id="first-used" placeholder="First Used" name="first_used"
                required>
            ...
            <div class="form-floating">
              <input type="number" class="form-control" id="calibration-freq" placeholder="Calibration Freq"
                name="calibration_freq" required>
...
@section('scripts')
  <script type="module">
    function fetchMasterLists(keyword = '', page = 1) {
      $('#loading').show();
      $.ajax({
        url: `{{ route('kalibrasi.admin.master-lists.search') }}`,
        type: 'GET',
        data: {
          keyword: keyword,
          page: page
