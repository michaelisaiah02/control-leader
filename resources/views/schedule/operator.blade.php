...
@section('content')
    <div class="container mt-3">
        ...
        <div class="text-center row justify-content-between align-items-start">
            ...
            <div id="pagination-links" class="col-md col align-items-center" data-url="{{ route('operator.search') }}">
                {{-- Generate by AJAX --}}
            </div>
            <div class="col-auto">
    ...
    <script type="module">
        ...
        $(document).ready(function() {
            ...
            $('#btn-add-operator').click(function() {
                ...
                $('#operatorForm').attr('action', "{{ route('operator.store') }}");
            });
            ...
            $(document).on('click', '.btn-edit-operator', function() {
                ...
                $('#operatorForm').attr('action', `{{ url('operator/update-operator') }}/${id}`);
            ...
            $(document).on('click', '.btn-delete-operator', function() {
                ...
                $('#deleteOperatorForm').attr('action',
                    `{{ url('operator/delete-operator') }}/${id}`);
