...
@section('scripts')
    <script type="module">
        function fetchUsers(keyword = '', page = 1, role = '') {
            $('#loading').show();
            $.ajax({
                url: `{{ route('control.admin.users.search') }}`,
                type: 'GET',
                data: {
                    keyword: keyword,
                    page: page,
        ...
        $(document).ready(function() {
            ...
            $('#btn-add-user').click(function() {
                ...
                $('#userForm').attr('action', "{{ route('control.admin.users.store') }}");
            });
            ...
            $(document).on('click', '.btn-edit-user', function() {
                ...
                $('#userForm').attr('action', `{{ url('control/admin/users/update-user') }}/${id}`);
            ...
            $(document).on('click', '.btn-delete-user', function() {
                ...
                $('#deleteUserForm').attr('action', `{{ url('control/admin/users/delete-user') }}/${id}`);
