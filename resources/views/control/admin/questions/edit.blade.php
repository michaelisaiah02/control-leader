    ...
    <div class="d-flex gap-5 w-100 mt-2 justify-content-between align-items-center my-2">
        ...
        <div class="d-flex align-items-center gap-2 w-100">
            ...
            <select name="package" id="package" class="form-select bg-warning-subtle" required>
                ...
                <option value="akhir_shift" {{ old('package', $question->package ?? '') == 'akhir_shift' ? 'selected' : '' }}>
                    Akhir Shift
                </option>
        ...
        <div class="col-md-8">
            <div id="builder" class="border border-primary p-3 rounded overflow-y-scroll"
                ...
                <div class="mb-3 border border-1 border-primary p-3 rounded field-block">
                    ...
                    <input type="text" name="problem_label" class="form-control border border-1 border-primary bg-warning-subtle" value="{{ $question->problem_label }}" required>
                </div>
                <div class="mb-3 border border-1 border-primary p-3 rounded field-block">
                    <label for="countermeasure_label" class="form-label my-2">Label Countermeasure</label>
                    <input type="text" id="countermeasure_label" name="countermeasure_label" class="form-control border border-1 border-primary bg-warning-subtle" value="{{ $question->countermeasure_label }}" required>
                </div>
                @endif
            </div>
        </div>
