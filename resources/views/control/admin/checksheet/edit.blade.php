            ...
            <div class="d-flex align-items-center gap-2 w-100">
                ...
                <select name="package" id="package" class="form-select bg-warning-subtle" required>
                    ...
                    <option value="awal_shift"
                        {{ old('package', $question->package ?? '') == 'awal_shift' ? 'selected' : '' }}>Awal Shift</option>
                    <option value="saat_bekerja"
                        {{ old('package', $question->package ?? '') == 'saat_bekerja' ? 'selected' : '' }}>Saat Bekerja
                    </option>
                    <option value="setelah_istirahat"
                        {{ old('package', $question->package ?? '') == 'setelah_istirahat' ? 'selected' : '' }}>Setelah
                        Istirahat
                    </option>
            ...
            <div class="col-md-8">
                <div id="builder" class="border border-primary p-3 rounded overflow-y-scroll"
                    ...
                    @if ($question->extra_fields)
                        ...
                        <div class="mb-3 border border-1 border-primary p-3 rounded field-block">
                            <input type="text" name="problem_label" class="w-100 border-0 my-2"
                                value="{{ $question->problem_label }}" required>
                            <input type="text"
                                class="form-control border border-1 border-primary bg-warning-subtle opacity-50" disabled>
                        </div>
                        <div class="mb-3 border border-1 border-primary p-3 rounded field-block">
                            <input type="text" name="countermeasure_label" class="w-100 border-0 my-2"
            ...
            <div class="col-md-4">
                <div class="d-grid gap-2 border border-primary p-3 rounded h-100">
                    <button type="button" class="btn btn-outline-primary add-field" data-type="radio">Tambah
                        Pilihan</button>
                    <button type="button" class="btn btn-outline-primary add-field" data-type="toggle">Problem dan
