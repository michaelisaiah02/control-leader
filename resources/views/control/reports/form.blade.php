...
@section('content')
    <form method="POST" class="px-5 my-5">
        @csrf
        @switch($type)
            @case('leader')
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="d-flex justify-content-center align-items-center gap-2 w-100">
                <div class="d-flex align-items-center gap-2 w-100">
                    <label for="month" class="text-center form-label bg-primary text-white px-4 py-2 rounded shadow border border-white">Month</label>
                    <input type="month" name="month" id="month" class="form-control bg-warning-subtle w-100" required />
                </div>
                <div class="d-flex align-items-center gap-2 w-100">
                    <label for="year" class="text-center form-label bg-primary text-white px-4 py-2 rounded shadow border border-white">Year</label>
                    <input type="number" name="year" id="year" min="1900" max="2100" placeholder="YYYY"  class="form-control bg-warning-subtle w-100" required />
                </div>
            </div>
        </div>
        ...
        @switch($type)
            @case('leader')
                <div class="my-3 pb-5 d-flex justify-content-center align-items-center gap-5">
                    <button type="submit" class="btn btn-primary btn-lg h-100 py-3 fs-4 align-content-center rounded-4 position-relative text-uppercase">View Leader Consistency Report</button>
                    <button type="submit" class="btn btn-primary btn-lg h-100 py-3 fs-4 align-content-center rounded-4 position-relative text-uppercase">View Score Leader Report</button>
                </div>
                @break
            @case('supervisor')
                <div class="my-3 pb-5 d-flex justify-content-center align-items-center gap-5">
                    <button type="submit" class="btn btn-primary btn-lg w-100 h-100 py-3 fs-4 align-content-center rounded-4 position-relative text-uppercase">View Supervisor Consistency Report</button>
                    <button type="submit" class="btn btn-primary btn-lg w-100 h-100 py-3 fs-4 align-content-center rounded-4 position-relative text-uppercase">View Score Supervisor Report</button>
                </div>
                @break
            @case('operator')
                <div class="my-3 pb-1 d-flex justify-content-center align-items-center gap-5">
                    <button type="submit" class="btn btn-primary btn-lg h-100 py-3 fs-4 align-content-center rounded-4 position-relative text-uppercase">View Score Performance Report</button>
                </div>
                @break
            @default
                <div></div>
